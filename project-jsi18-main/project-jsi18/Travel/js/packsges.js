...
querySnapshot.forEach((doc) => {
  ...
  bag += `
  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="display:inline-block; width:400px; margin-left:80px; margin-top: 10px">
  <div class="package-item">
      <div class="overflow-hidden" style="width: 400px;height: 300px;">
          <img class="img-fluid" style="width:100%;height: 300px;" src="${doc.data().link}" alt="">
      </div>
