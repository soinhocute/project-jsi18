...
querySnapshot.forEach((item) => {
  ...
  td_buttons.appendChild(newBtn)
  td_buttons.appendChild(Btn)
  row.innerHTML = row_ticket
...
document.getElementById("Booking").onclick = async () => {
  window.location.replace("../zTestAdmin/index.html")
};
document.getElementById("Signout").onclick = async () => {
  window.location.replace("../Travel/Signin/index.html")
};